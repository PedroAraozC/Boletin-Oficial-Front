...
export default function ListaPrueba() {
  ...
  const list = () => (
    ...
    >
      ...
      {/* Inicio */}
      <ListItemButton onClick={() => redirigir("/")} component="a" className="w-100">
        <ListItemIcon >
          <ArticleIcon />
        </ListItemIcon>
        <ListItemText primary="BOLETINES" />
      </ListItemButton>
      <ListItemButton onClick={() => redirigir("/adminBoletin")} component="a" className="w-100">
        <ListItemIcon >
          <SupervisorAccountIcon />
        </ListItemIcon>
        <ListItemText primary="ADMIN BOLETIN" />
      </ListItemButton>
      <ListItemButton onClick={() => redirigir("/altaBoletines")} component="a" className="w-100">
        <ListItemIcon >
          <NoteAddIcon />
        </ListItemIcon>
        <ListItemText primary="ALTA BOLETINES" />
      </ListItemButton>
      <ListItemButton onClick={() => redirigir("/tablas")} component="a" className="w-100">
        <ListItemIcon >
          <TableViewIcon />
        </ListItemIcon>
        <ListItemText primary="NORMA/SECRETARIA" />
      </ListItemButton>
      <ListItemButton onClick={() => redirigir("/tablaBoletines")} component="a" className="w-100">
        <ListItemIcon >
          <EditNoteIcon />
        </ListItemIcon>
